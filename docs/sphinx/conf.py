...
class ExtendedCppLexer(CppLexer):
    tokens = {
        "statements": [include("xfunction"), include("xmethod"), include("xclass"), inherit],
        "xfunction": [
            (
...
class ExtendedPythonLexer(PythonLexer):
    tokens = {
        "name": [include("xfunction"), include("xmethod"), include("xclass"), inherit],
        "xfunction": [
            (
...
latex_documents = [
    (master_doc, "Reaktoro.tex", "Reaktoro Documentation", "Allan Leal", "manual"),
]
...
man_pages = [(master_doc, "reaktoro", "Reaktoro Documentation", [author], 1)]
