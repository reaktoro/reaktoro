...
void exportSmartEquilibriumResult(py::module& m)
{
    py::class_<SmartEquilibriumTiming>(m, "SmartEquilibriumTiming")
        ...
        .def_readwrite("learning_gibbs_energy_minimization", &SmartEquilibriumTiming::learning_gibbs_energy_minimization, "The time spent in seconds for a conventional Gibbs energy minimization calculation during learning operation.")
        .def_readwrite("learning_chemical_properties", &SmartEquilibriumTiming::learning_chemical_properties, "The time spent in seconds for computing the chemical properties during learning operation.")
        .def_readwrite("learning_sensitivity_matrix", &SmartEquilibriumTiming::learning_sensitivity_matrix, "The time spent in seconds for computing the sensitivity matrix during learning operation.")
        .def_readwrite("learning_error_control_matrices", &SmartEquilibriumTiming::learning_error_control_matrices, "The time spent in seconds for computing the error control matrices during learning operation.")
        .def_readwrite("learning_storage", &SmartEquilibriumTiming::learning_storage, "The time spent in seconds for storing the computed chemical state into the tree of knowledge.")
