...
void exportSmartEquilibriumResult(py::module& m)
{
    py::class_<SmartEquilibriumTiming>(m, "SmartEquilibriumTiming")
        ...
        .def_readwrite("learning", &SmartEquilibriumTiming::learn)
        .def_readwrite("learning_gibbs_energy_minimization", &SmartEquilibriumTiming::learn_gibbs_energy_minimization)
        .def_readwrite("learning_chemical_properties", &SmartEquilibriumTiming::learn_chemical_properties)
        .def_readwrite("learning_sensitivity_matrix", &SmartEquilibriumTiming::learn_sensitivity_matrix)
        .def_readwrite("learning_storage", &SmartEquilibriumTiming::learn_storage)
