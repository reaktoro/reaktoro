...
from dolfin import *
from core import *
from core.chemicalfield import *
from core.mobility import *
from transport.chemicaltransport import *
...
field = ChemicalField(system, CG)
field.set(state_ic)

transport = ChemicalTransportSolver(system, mobility)
