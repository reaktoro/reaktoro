...
//auto elementIndices(const Multiphase& multiphase, const std::vector<std::string>& elements) -> Indices;
//
...
//auto speciesIndex(const Multiphase& multiphase, const std::string& species) -> Index;
//
...
//auto speciesIndices(const Multiphase& multiphase, const std::vector<std::string>& species) -> Indices;
//
...
//auto phaseIndex(const Multiphase& multiphase, const std::string& phase) -> Index;
//
