...
#include "ElectroStateSpeciesHKF.hpp"
...
FunctionG::FunctionG(double T, double P, const ThermoStateWater& wt)
{
...
auto speciesElectroHKF(const FunctionG& g, const AqueousSpecies& species) -> ElectroStateSpecies
{
...
auto speciesElectroHKF(double T, double P, const AqueousSpecies& species) -> ElectroStateSpecies
{
    ThermoStateWater wt = waterThermo(T, P);
