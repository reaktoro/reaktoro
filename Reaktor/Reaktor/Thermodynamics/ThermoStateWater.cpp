...
#include <Reaktor/Thermodynamics/ThermoStateWaterWagnerPruss.hpp>

namespace Reaktor {

ThermoStateWater::ThermoStateWater()
...
auto waterThermo(double T, double P, ThermoStateWaterModel model) -> ThermoStateWater
{
	...
	HelmholtzStateWater wh = waterHelmholtz(T, D, model);
...
auto densityWater(double T, double P, ThermoStateWaterModel model) -> double
{
	...
	{
		HelmholtzStateWater h = waterHelmholtz(T, D, model);
