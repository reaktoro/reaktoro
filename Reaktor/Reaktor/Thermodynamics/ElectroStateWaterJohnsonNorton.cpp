...
#include "ElectroStateWaterJohnsonNorton.hpp"
...
auto waterElectroJohnsonNorton(double T, double P, const ThermoStateWater& wt) -> ElectroStateWater
{
	ElectroStateWater we;
