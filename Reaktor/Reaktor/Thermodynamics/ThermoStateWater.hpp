...
struct HelmholtzStateWater;

struct ThermoStateWater
{
	/// Constructs a default ThermoStateWater instance
	ThermoStateWater();
 ...
 */
auto operator<<(std::ostream& out, const ThermoStateWater& ts) -> std::ostream&;
 ...
 *
 * @return The thermodynamic state of water, as an instance of @ref ThermoStateWater
 */
auto waterThermo(double T, double P) -> ThermoStateWater;
 ...
 * @param T The temperature of water (in units of K)
 * @param P The pressure of water (in units of Pa)
 * @param model The thermodynamic model as an instance of @ref ThermoStateWaterModel
 *
 * @return The thermodynamic state of water, as an instance of @ref ThermoStateWater
 */
auto waterThermo(double T, double P, ThermoStateWaterModel model) -> ThermoStateWater;

/**
 * Calculates the thermodynamic state of water
 *
 * This is a general method that uses the Helmholtz free enery state
 * of water, as an instance of @ref HelmholtzStateWater, to completely
 * resolve the thermodynamic state of water.
 *
 * @param T The temperature of water (in units of K)
 * @param P The pressure of water (in units of Pa)
 * @param D The density of water (in units of kg/m3)
 * @param wh The Helmholtz free energy state of water, as an instance of @ref HelmholtzStateWater
 *
 * @return The thermodynamic state of water, as an instance of @ref ThermoStateWater
 */
auto waterThermo(double T, double P, double D, const HelmholtzStateWater& wh) -> ThermoStateWater;
 ...
 * @return The density of water (in units of kg/m3)
 */
auto densityWater(double T, double P, ThermoStateWaterModel model) -> double;
 ...
 * @return The pressure of water (in units of Pa)
 */
auto pressureWater(double T, double D, ThermoStateWaterModel model) -> double;
