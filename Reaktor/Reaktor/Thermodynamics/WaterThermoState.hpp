...
{
	/// Constructs a default WaterThermoState instance
	WaterThermoState();
 ...
 *
 * @return The thermodynamic state of water, as an instance of @ref WaterThermoState
 */
 ...
 * of water, as an instance of @ref WaterHelmholtzState, to completely
 * resolve the thermodynamic state of water.
 *
 * @param T The temperature of water (in units of K)
 * @param P The pressure of water (in units of Pa)
 * @param D The density of water (in units of kg/m3)
 * @param wh The Helmholtz free energy state of water, as an instance of @ref WaterHelmholtzState
 *
 * @return The thermodynamic state of water, as an instance of @ref WaterThermoState
 */
