...
public:
    /**
     * Constructs a default aqueous phase instance
     */
    AqueousPhase();

    /**
     * Constructs an aqueous phase instance with given species
     */
    ...
    /**
     * Sets the activity model of the species to be the Setschenow one
     *
     * @param species The name of species to have its activity model set
    ...
    /**
     * Sets the activity model of CO2(aq) to be the one of Duan and Sun (2003)
     */
    auto setActivityModelDuanSunCO2() -> void;

    /**
     * Sets the activity model of CO2(aq) to be the one of Drummond (1981)
     */
    auto setActivityModelDrummondCO2() -> void;

    /**
     * Sets the activity model of CO2(aq) to be the one of Rumpf et al. (1994)
     */
    auto setActivityModelRumpfCO2() -> void;

    /**
     * Sets the activity model of H2O(l) to be the one of Helgeson et al. (1981)
     */
    auto setActivityModelHKFWater() -> void;

    /**
     * Sets the activity models of charged species to be the one of Helgeson et al. (1981)
     */
    auto setActivityModelHKFChargedSpecies() -> void;

    /**
     * Sets the activity model of H2O(l) to the Pitzer's model of Harvie et al. (1984)
     */
    auto setActivityModelPitzerWater() -> void;

    /**
     * Sets the activity model of the charged species to the Pitzer's model of Harvie et al. (1984)
     */
    auto setActivityModelPitzerChargedSpecies() -> void;

    /**
     * Sets the activity model of a neutral species to the Pitzer's model of Harvie et al. (1984)
     *
    ...
    /**
     * Calculates the parameters for the aqueous activity calculation
     *
    ...
    /**
     * Calculates the concentrations of the aqueous species
    ...
    /**
     * Calculates the activities of the aqueous species and its molar derivatives
     *
     * @param T The temperature used for the calculation (in units of K)
     * @param P The pressure used for the calculation (in units of bar)
     * @param n The molar composition of the aqueous phase
