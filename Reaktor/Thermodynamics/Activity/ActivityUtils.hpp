...
//struct GaseousMixtureState : public SolutionState
//{};
//
///// A type used to describe the state of a mineral solution
//struct MineralMixtureState : public SolutionState
//{};
//
...
//auto indexSpecies(const Solution& solution, const std::string& name) -> Index;
//
...
//auto gaseousSolutionStateFunction(const GaseousMixture& solution) -> GaseousMixtureStateFunction;
//
///// Create a function for the state calculation of a mineral solution
///// @param solution The mineral solution
//auto mineralSolutionStateFunction(const MineralMixture& solution) -> MineralMixtureStateFunction;
//
//} // namespace Reaktor
//
