...
/**
 * Returns a vector of all known 116 chemical elements
 */
auto elements() -> std::vector<std::string>;

/**
 * Determines the elemental composition of a chemical compound
...
/**
 * Calculates the atomic mass of a chemical element
 * @param element The symbol of the chemical element
 * @return The atomic mass of the chemical element
 */
auto atomicMass(std::string element) -> units::MolarMass;
 ...
 */
auto molarMass(const std::map<std::string, double>& compound) -> units::MolarMass;
 ...
 * @return The molar mass of the chemical compound
 */
auto molarMass(std::string formula) -> units::MolarMass;

/**
 * Extracts the electrical charge of a chemical formula
 *
