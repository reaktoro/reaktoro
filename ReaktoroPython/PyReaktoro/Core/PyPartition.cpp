...
auto export_Partition() -> void
{
    ...
    py::class_<Partition>("Partition")
        ...
        .def("indexEquilibriumSpecies", &Partition::indexEquilibriumSpecies)
        .def("indexEquilibriumElement", &Partition::indexEquilibriumElement)
        .def("indexKineticSpecies", &Partition::indexKineticSpecies)
        .def("indexKineticElement", &Partition::indexKineticElement)
        .def("indexInertSpecies", &Partition::indexInertSpecies)
        .def("indexInertElement", &Partition::indexInertElement)
