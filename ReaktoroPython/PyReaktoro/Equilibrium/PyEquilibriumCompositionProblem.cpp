...
auto export_EquilibriumCompositionProblem() -> void
{
    py::class_<EquilibriumCompositionProblem>("EquilibriumCompositionProblem")
        ...
        .def("setAqueousFluid", &EquilibriumCompositionProblem::setAqueousComposition)
        .def("setGaseousFluid", &EquilibriumCompositionProblem::setGaseousComposition)
        .def("setSolid", &EquilibriumCompositionProblem::setSolidComposition)
