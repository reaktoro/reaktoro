...
@pytest.mark.parametrize(
    ...
    [(153.15, 10132.5), (153.15, 101325.0), (153.15, 2026500.0), (153.15, 3039750.0),],
    ids=[
...
def test_equilibrium_CH4_liq_gas(temperature, pressure, num_regression):
    ...
    eos_params.phase_identification_method = (
        PhaseIdentificationMethod.GibbsEnergyAndEquationOfStateMethod
    )
...
@pytest.mark.parametrize(
    "temperature, pressure",
    [(323.15, 1013250.0), (323.15, 2026500.0), (323.15, 5066250.0), (323.15, 6079500.0),],
    ids=[
...
@pytest.mark.parametrize(
    "temperature, pressure",
    [(273.15, 1000000.0), (273.15, 2000000.0), (273.15, 4000000.0), (273.15, 5000000.0),],
    ids=[
...
@pytest.mark.parametrize(
    "temperature, pressure",
    [(190.0, 8.0), (196.0, 15.0),],
    ids=["temperature equal 190.0 K and 8.0 bar", "temperature equal 196.0 K and 15.0 bar",],
)
...
@pytest.mark.parametrize(
    "temperature, pressure",
    [(273.15, 30.0), (293.15, 70.0),],
    ids=["temperature equal 273.15 K and 30.0 bar", "temperature equal 293.15 K and 70.0 bar",],
)
...
@pytest.mark.parametrize(
    "temperature, pressure",
    [(233.15, 20.0), (273.15, 40.0), (293.15, 70.0),],
    ids=[
...
def test_equilibrium_CH4_CO2_H2S_liq_gas(temperature, pressure, num_regression):
    ...
    editor.addLiquidPhase(["CH4(liq)", "H2S(liq)", "CO2(liq)"]).setChemicalModelPengRobinson(
        eos_params
    )
