...
auto runReactiveTransport(ReactiveTransportParams& params, ReactiveTransportKineticsResults& results) -> void
{
    ...
    auto folder = params.makeResultsFolderKinetics("scavenging-complex-eq-calcite");
    ...
    partition.setKineticSpecies(std::vector<std::string>{"Daphnite,14A", "Siderite", "Kaolinite", "Quartz"});
