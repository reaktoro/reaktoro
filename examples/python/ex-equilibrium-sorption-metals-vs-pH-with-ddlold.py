...
hfo_w_phase.setActivityModel(ActivityModelSurfaceComplexationSiteWithDDLOld(params_site))

params_site.site_tag = "_s";
hfo_s_phase = SurfaceComplexationPhase(species_str_s)
hfo_s_phase.setName("Hfo_s")
hfo_s_phase.setActivityModel(ActivityModelSurfaceComplexationSiteWithDDLOld(params_site))
...
ax.set_title("Dependence of metal sorption on pH (with DDL)")
ax.set_xlabel("pH")
...
ax.legend(loc="best")
ax.grid()
plt.savefig("sorbed-metals-vs-pH-with-ddlod.png", bbox_inches='tight')
plt.close()
