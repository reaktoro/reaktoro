...
print(f"  pH   x(Hfo_sOH) x(Hfo_sOH2+)   x(Hfo_sO-)   x(Hfo_wOH) x(Hfo_wOH2+)   x(Hfo_wO-) succeed            I            Z        sigma")
for pH in pHs:
      ...
      print(f"{pH:4.1f} {xHfo_sOH:12.4e} {xHfo_sOH2:12.4e} {xHfo_sO:12.4e} {xHfo_wOH:12.4e} {xHfo_wOH2:12.4e} {xHfo_wO:12.4e} {res.optima.succeeded:7d}  {float(aprops.ionicStrengt.h()):12.4e} {Z:12.4e} {sigma:12.4e}")
...
ax.legend(loc="best")
ax.grid()
plt.savefig(f"sorbed-fractions-with-esurf-h2o-vs-pH-NaCl-{nNaCl}.png", bbox_inches='tight')
plt.close()