...
auto runReactiveTransport(ReactiveTransportParams& params, ReactiveTransportResults& results) -> void
{
    ...
    MineralPhases mineralphases("Pyrrhotite Siderite");
    ...
    state_ic.setSpeciesAmount("Pyrrhotite", 0.0, "mol");
    state_ic.setSpeciesAmount("Siderite", 0.5, "mol");
    ...
    state_bc.setSpeciesAmount("Pyrrhotite", 0.0, "mol");
    state_bc.setSpeciesAmount("Siderite", 0.0, "mol");
