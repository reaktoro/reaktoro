...
int main()
{
    ...
    surface_Hfo.addSite("Hfo_s", "_s")
        .setAmount(1.0, "mol")
        .setSpecificSurfaceArea(1e3, "m2/g")
        .setMass(0.33, "g");
    ...
    solutionstate.setSpeciesAmount("Hfo_sOH"  , 1.00, "mol");
    solutionstate.setSpeciesAmount("Hfo_wOH"  , 1.00, "mol");
    ...
    ComplexationSurfaceProps surface_props(solutionstate);
