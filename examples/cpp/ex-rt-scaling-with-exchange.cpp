...
auto runReactiveTransport(ReactiveTransportParams& params, ReactiveTransportResults& results) -> void
{
    ...
    auto folder = params.makeResultsFolder("scaling-with-exchange");
    ...
    StringList selected_species = "H2O H+ OH- Na+ Cl- Ca+2 Mg+2 Ba+2 Sr+2 K+ HCO3- CO2 CO3-2 O2 SO4-2";
    ...
    IonExchangePhase exchange_phase("NaX BaX2");
    ...
    ChemicalSystem system(db, aqueousphase, mineralphase, exchange_phase);
    ...
    state_ic.setSpeciesMass("H2O", water_kg, "kg");
    ...
    state_ic.setSpeciesAmount("BaX2", 2.5e-5, "mol");
    ...
    state_bc.setSpeciesMass("H2O", water_kg, "kg");
    ...
    output.add("speciesAmount(NaX)");
    output.add("speciesAmount(BaX2)");
