...
void exportThermoProps(py::module& m)
{
    ...
    py::class_<ThermoProps>(m, "ThermoProps")
        ...
        .def("standardVolumesT", &ThermoProps::standardVolumesT, py::return_value_policy::reference_internal)
        .def("standardVolumesP", &ThermoProps::standardVolumesP, py::return_value_policy::reference_internal)
