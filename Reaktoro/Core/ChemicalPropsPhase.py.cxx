...
auto createTemplateClassForChemicalPropsPhaseType(py::module& m, const char* name)
{
    return py::class_<ChemicalPropsPhaseType>(m, name)
        ...
        .def("speciesMoleFractions", &ChemicalPropsPhaseType::speciesMoleFractions, py::return_value_policy::reference_internal, "Return the mole fractions of the species in the phase.")
        .def("speciesActivityCoefficientsLn", &ChemicalPropsPhaseType::speciesActivityCoefficientsLn, py::return_value_policy::reference_internal, "Return the ln activity coefficients of the species in the phase.")
        .def("speciesActivitiesLn", &ChemicalPropsPhaseType::speciesActivitiesLn, py::return_value_policy::reference_internal, "Return the ln activities of the species in the phase.")
        .def("speciesChemicalPotentials", &ChemicalPropsPhaseType::speciesChemicalPotentials, py::return_value_policy::reference_internal, "Return the chemical potentials of the species in the phase (in J/mol).")
        .def("speciesStandardVolumes", &ChemicalPropsPhaseType::speciesStandardVolumes, py::return_value_policy::reference_internal, "Return the standard partial molar volumes of the species in the phase (in m³/mol).")
        .def("speciesStandardVolumesT", &ChemicalPropsPhaseType::speciesStandardVolumesT, py::return_value_policy::reference_internal, "Return the temperature derivative of the standard molar volumes of the species in the phase (in m³/(mol·K)).")
        .def("speciesStandardVolumesP", &ChemicalPropsPhaseType::speciesStandardVolumesP, py::return_value_policy::reference_internal, "Return the pressure derivative of the standard molar volumes of the species in the phase (in m³/(mol·K)).")
        .def("speciesStandardGibbsEnergies", &ChemicalPropsPhaseType::speciesStandardGibbsEnergies, py::return_value_policy::reference_internal, "Return the standard partial molar Gibbs energies of formation of the species in the phase (in J/mol).")
        .def("speciesStandardEnthalpies", &ChemicalPropsPhaseType::speciesStandardEnthalpies, py::return_value_policy::reference_internal, "Return the standard partial molar enthalpies of formation of the species in the phase (in J/mol).")
        ...
        .def("speciesStandardHeatCapacitiesConstP", &ChemicalPropsPhaseType::speciesStandardHeatCapacitiesConstP, py::return_value_policy::reference_internal, "Return the standard partial molar isobaric heat capacities of the species in the phase (in J/(mol·K)).")
        .def("speciesStandardHeatCapacitiesConstV", &ChemicalPropsPhaseType::speciesStandardHeatCapacitiesConstV, py::return_value_policy::reference_internal, "Return the standard partial molar isochoric heat capacities of the species in the phase (in J/(mol·K)).")
