...
void exportChemicalPropsPhase(py::module& m)
{
    ...
    py::class_<ChemicalPropsPhase>(m, "ChemicalPropsPhase")
        ...
        .def("standardVolumesT", &ChemicalPropsPhase::standardVolumesT, py::return_value_policy::reference_internal)
        .def("standardVolumesP", &ChemicalPropsPhase::standardVolumesP, py::return_value_policy::reference_internal)
        ...
        .def("molarMass", &ChemicalPropsPhase::molarMass)
        .def("molarVolume", &ChemicalPropsPhase::molarVolume)
        .def("molarVolumeT", &ChemicalPropsPhase::molarVolumeT)
        .def("molarVolumeP", &ChemicalPropsPhase::molarVolumeP)
        ...
        .def("density", &ChemicalPropsPhase::density)
        .def("amount", &ChemicalPropsPhase::amount)
        .def("mass", &ChemicalPropsPhase::mass)
        .def("volume", &ChemicalPropsPhase::volume)
        .def("volumeT", &ChemicalPropsPhase::volumeT)
        .def("volumeP", &ChemicalPropsPhase::volumeP)
