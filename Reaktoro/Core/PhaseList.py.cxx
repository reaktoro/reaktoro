...
void exportPhaseList(py::module& m)
{
    py::class_<PhaseList>(m, "PhaseList")
        ...
        .def("append", &PhaseList::append, "Append a new phase to the list of phases.")
        ...
        .def("indicesSpeciesInPurePhases", &PhaseList::indicesSpeciesInPurePhases, "Return the indices of the species in phases with a single species.")
        ...
        .def("__getitem__", [](PhaseList& self, Index i) { return self[i]; }, return_internal_ref)
