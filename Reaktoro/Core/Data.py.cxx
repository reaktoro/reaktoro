...
void exportData(py::module& m)
{
    py::class_<Data>(m, "Data")
        ...
        .def("__getitem__", [](Data const& self, Chars const& key) { return self[key]; }, "Return the child data block with given key, presuming this data block is a dictionary.")
        ...
        .def("__getitem__", [](Data const& self, int const& index) { return self[index]; }, "Return the child data block with given index, presuming this data block is a list.")
        ...
        .def("at", py::overload_cast<String const&>(&Data::at, py::const_), "Return the child data block with given key, presuming this data block is a dictionary.")
        .def("at", py::overload_cast<Index const&>(&Data::at, py::const_), "Return the child data block with given index, presuming this data block is a list.")
        .def("at", py::overload_cast<String const&>(&Data::at), "Return the child data block with given key or create it if not existent, presuming this data block is a dictionary.")
        .def("at", py::overload_cast<Index const&>(&Data::at), "Return the child data block with given index or create it if not existent, presuming this data block is a list.")
