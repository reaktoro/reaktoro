...
void exportData(py::module& m)
{
    py::class_<Data>(m, "Data")
        ...
        .def_static("parseYaml", py::overload_cast<Chars>(&Data::parseYaml), "Return a Data object by parsing an YAML document.")
        .def_static("parseYaml", py::overload_cast<String const&>(&Data::parseYaml), "Return a Data object by parsing an YAML document.")
        .def_static("parseYaml", py::overload_cast<std::istream&>(&Data::parseYaml), "Return a Data object by parsing an YAML document.")
        .def_static("parseJson", py::overload_cast<Chars>(&Data::parseJson), "Return a Data object by parsing a JSON document.")
        .def_static("parseJson", py::overload_cast<String const&>(&Data::parseJson), "Return a Data object by parsing a JSON document.")
        .def_static("parseJson", py::overload_cast<std::istream&>(&Data::parseJson), "Return a Data object by parsing a JSON document.")
