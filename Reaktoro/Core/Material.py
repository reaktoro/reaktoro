...
def testChemicalFormula():
    ...
    assert Material.equivalent("Ca++", "Ca+2")
    assert Material.equivalent("Ca++", "Ca[2+]")
    assert Material.equivalent("Ca++", "Ca[2+](aq)")

    assert Material.equivalent("CO3--", "CO3-2")
    assert Material.equivalent("CO3--", "CO3[2-]")
    assert Material.equivalent("CO3--", "CO3[2-](aq)")

    assert Material.equivalent("Fe+++", "Fe+3")
    assert Material.equivalent("Fe+++", "Fe[3+]")
    assert Material.equivalent("Fe+++", "Fe[3+](aq)")

    assert Material.equivalent("H+", "H+1")
    assert Material.equivalent("H+", "H[+]")
    assert Material.equivalent("H+", "H[+](aq)")

    assert Material.equivalent("OH-", "OH-1")
    assert Material.equivalent("OH-", "OH[-]")
    assert Material.equivalent("OH-", "OH[-](aq)")

    assert Material.equivalent("CO2", "CO2(g)")
    assert Material.equivalent("CO2", "COO")
