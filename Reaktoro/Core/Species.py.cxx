...
void exportSpecies(py::module& m)
{
    py::class_<Species>(m, "Species")
        ...
        .def("withStandardGibbsEnergyFn", &Species::withStandardGibbsEnergyFn)
        .def("withStandardThermoPropsFn", &Species::withStandardThermoPropsFn)
        ...
        .def("standardThermoPropsFn", &Species::standardThermoPropsFn, py::return_value_policy::reference_internal)
