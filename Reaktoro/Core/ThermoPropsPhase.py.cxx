...
void exportThermoPropsPhase(py::module& m)
{
    ...
    py::class_<ThermoPropsPhase>(m, "ThermoPropsPhase")
        ...
        .def("standardVolumesT", &ThermoPropsPhase::standardVolumesT, py::return_value_policy::reference_internal)
        .def("standardVolumesP", &ThermoPropsPhase::standardVolumesP, py::return_value_policy::reference_internal)
