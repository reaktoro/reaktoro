...
auto Phase::properties(ThermoScalar T, ThermoScalar P) const -> ThermoProperties
{
    return pimpl->properties(T, P);
}

auto Phase::properties(ThermoScalar T, ThermoScalar P, const Vector& n) const -> PhaseChemicalProperties
{
