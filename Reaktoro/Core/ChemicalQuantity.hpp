...
public:
    ...
    /// Update the state of this ChemicalQuantity instance.
    auto update(const ChemicalState& state, real t) -> ChemicalQuantity&;

    /// Update the state of this ChemicalQuantity instance at the time t.
    auto update(const ChemicalState& state, const ChemicalProps& properties, real t) -> ChemicalQuantity&;
