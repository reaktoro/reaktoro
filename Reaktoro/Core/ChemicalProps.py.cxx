...
void exportChemicalProps(py::module& m)
{
    py::class_<ChemicalProps>(m, "ChemicalProps")
        ...
        .def("concentration", &ChemicalProps::concentration)
        .def("lgConcentration", &ChemicalProps::lgConcentration)
        .def("lnConcentration", &ChemicalProps::lnConcentration)
        ...
        .def("standardVolumeT", &ChemicalProps::standardVolumeT)
        .def("standardVolumeP", &ChemicalProps::standardVolumeP)
        ...
        .def("lnConcentrations", &ChemicalProps::lnConcentrations)
        ...
        .def("standardVolumesT", &ChemicalProps::standardVolumesT, py::return_value_policy::reference_internal)
        .def("standardVolumesP", &ChemicalProps::standardVolumesP, py::return_value_policy::reference_internal)
