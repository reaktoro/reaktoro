...
void exportChemicalProps(py::module& m)
{
    py::class_<ChemicalProps>(m, "ChemicalProps")
        ...
        .def("update", py::overload_cast<real const&, real const&, ArrayXrConstRef>(&ChemicalProps::update), "Update the chemical properties of the system.")
        .def("update", py::overload_cast<real const&, real const&, ArrayXrConstRef, ArrayXrConstRef>(&ChemicalProps::update), "Update the chemical properties of the system.")
        ...
        .def("updateIdeal", py::overload_cast<ChemicalState const&>(&ChemicalProps::updateIdeal), "Update the chemical properties of the system using ideal activity models.")
        .def("updateIdeal", py::overload_cast<real const&, real const&, ArrayXrConstRef>(&ChemicalProps::updateIdeal), "Update the chemical properties of the system using ideal activity models.")
        .def("updateIdeal", py::overload_cast<real const&, real const&, ArrayXrConstRef, ArrayXrConstRef>(&ChemicalProps::updateIdeal), "Update the chemical properties of the system using ideal activity models.")
        ...
        .def("componentAmounts", &ChemicalProps::componentAmounts, "Return the amounts of the conservative components (elements and charge) in the system (in mol).")
        .def("componentAmountsInPhase", &ChemicalProps::componentAmountsInPhase, "Return the amounts of the conservative components (elements and charge) in a phase of the system (in mol).")
        .def("componentAmountsAmongSpecies", &ChemicalProps::componentAmountsAmongSpecies, "Return the amounts of the conservative components (elements and charge) among a group of species in the system (in mol).")
        ...
        .def("surfaceArea", py::overload_cast<StringOrIndex const&, StringOrIndex const&>(&ChemicalProps::surfaceArea, py::const_), "Return the surface area of the interface between two reacting phases (in m2).")
        .def("surfaceArea", py::overload_cast<Index>(&ChemicalProps::surfaceArea, py::const_), "Return the surface area of the interface between two reacting phases with given surface index (in m2).")
        .def("surfaceAreas", &ChemicalProps::surfaceAreas, return_internal_ref, "Return the areas of all reacting phase interfaces in the system.")
        ...
        .def("reactionRates", &ChemicalProps::reactionRates, "Return the reaction rates of the kinetic reactions in the system (in mol/s).")
        ...
        .def("output", py::overload_cast<String const&>(&ChemicalProps::output, py::const_), "Output the chemical properties of the system to a file.")
        .def("__repr__", [](ChemicalProps const& self) { std::stringstream ss; ss << self; return ss.str(); })
        ;
}
