...
void to_json(json& j, const KineticPathAnalysis& obj) {
    ...
    j["steps_where_learning_was_required"] = obj.smart_equilibrium.steps_where_learning_was_required;
    ...
    j["num_kinetic_calculations"] = obj.smart_kinetics.num_kinetic_calculations;
    j["num_smart_kinetic_accepted_estimates"] = obj.smart_kinetics.num_smart_kinetic_accepted_estimates;
    j["num_smart_kinetic_required_learnings"] = obj.smart_kinetics.num_smart_kinetic_required_learnings;
    j["smart_kinetic_estimate_acceptance_rate"] = obj.smart_kinetics.smart_kinetic_estimate_acceptance_rate;
    j["steps_where_learning_was_required"] = obj.smart_kinetics.steps_where_learning_was_required;
...
void from_json(const json& j, KineticPathAnalysis& obj) {
    ...
    j.at("steps_where_learning_was_required").get_to(obj.smart_equilibrium.steps_where_learning_was_required);

    j.at("smart_kinetics").at("timing").get_to(obj.smart_kinetics.timing);
    j.at("num_kinetics_calculations").get_to(obj.smart_kinetics.num_kinetic_calculations);
    j.at("num_smart_kinetics_accepted_estimates").get_to(obj.smart_kinetics.num_smart_kinetic_accepted_estimates);
    j.at("num_smart_kinetics_required_learnings").get_to(obj.smart_kinetics.num_smart_kinetic_required_learnings);
    j.at("smart_kinetics_estimate_acceptance_rate").get_to(obj.smart_kinetics.smart_kinetic_estimate_acceptance_rate);
    j.at("steps_where_learning_was_required").get_to(obj.smart_kinetics.steps_where_learning_was_required);
