...
//======================================================================
// Parameters in YAML format for reaction rate models (rrm)
//======================================================================
String params_rrm_palandri_kharaka_1 = R"xyz(
Mineral: Halite
Mechanisms:
    Neutral:   { lgk: -0.21, E: 7.4 }
)xyz";

String params_rrm_palandri_kharaka_2 = R"xyz(
Mineral: Pyrite
Mechanisms:
...
String params_rrm_palandri_kharaka_3 = R"xyz(
Mineral: Epidote
Mechanisms:
...
String params_rrm_palandri_kharaka_4 = R"xyz(
