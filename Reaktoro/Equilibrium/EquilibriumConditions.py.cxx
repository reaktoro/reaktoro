...
void exportEquilibriumConditions(py::module& m)
{
    ...
    py::class_<EquilibriumConditions>(m, "EquilibriumConditions")
        ...
        .def("startWithTemperature", py::overload_cast<real>(&EquilibriumConditions::startWithTemperature))
        .def("startWithTemperature", py::overload_cast<real, String>(&EquilibriumConditions::startWithTemperature))
        .def("startWithPressure", py::overload_cast<real>(&EquilibriumConditions::startWithPressure))
        .def("startWithPressure", py::overload_cast<real, String>(&EquilibriumConditions::startWithPressure))
        .def("startWithSpeciesAmounts", &EquilibriumConditions::startWithSpeciesAmounts)
        ...
        .def("startWithState", &EquilibriumConditions::startWithState)
        ...
        .def("initialTemperature", &EquilibriumConditions::initialTemperature)
        .def("initialPressure", &EquilibriumConditions::initialPressure)
