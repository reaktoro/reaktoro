...
void exportEquilibriumSpecs(py::module& m)
{
    ...
    py::class_<EquilibriumSpecs>(m, "EquilibriumSpecs")
        ...
        .def("numParameters", &EquilibriumSpecs::numParameters)
        ...
        .def("namesParameters", &EquilibriumSpecs::namesParameters)
        ...
        .def("addParameter", py::overload_cast<String>(&EquilibriumSpecs::addParameter), return_internal_ref)
        .def("addParameter", py::overload_cast<Param>(&EquilibriumSpecs::addParameter), return_internal_ref)
        .def("system", &EquilibriumSpecs::system, return_internal_ref)
        .def("params", &EquilibriumSpecs::params)
