...
void exportEquilibriumSpecs(py::module& m)
{
    ...
    py::class_<EquilibriumSpecs>(m, "EquilibriumSpecs")
        ...
        .def("numInputParams", &EquilibriumSpecs::numInputParams, "Return the number of model parameters among the introduced input variables.")
        ...
        .def("namesInputParams", &EquilibriumSpecs::namesInputParams, "Return the names of the model parameters among the input variables.")
        ...
        .def("addInput", py::overload_cast<Param const&>(&EquilibriumSpecs::addInput), "Add model parameter `param` as a new input variable for the chemical equilibrium problem.")
        ...
        .def("indicesInputParams", &EquilibriumSpecs::indicesInputParams, "Return the indices of the model parameters among the input variables.")
        ...
        .def("indicesSurfaceAreasAmongInputVariables", &EquilibriumSpecs::indicesSurfaceAreasAmongInputVariables, "Return the indices of surface areas in the vector of w input variables.")
