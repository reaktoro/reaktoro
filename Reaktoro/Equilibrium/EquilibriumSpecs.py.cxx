...
void exportEquilibriumSpecs(py::module& m)
{
    ...
    py::class_<EquilibriumSpecs>(m, "EquilibriumSpecs")
        ...
        .def("indexControlVariableTemperature", &EquilibriumSpecs::indexControlVariableTemperature, "The index of temperature among the *p* control variables or `Index(-1)` if it is a given input.")
        .def("indexControlVariablePressure", &EquilibriumSpecs::indexControlVariablePressure, "The index of pressure among the *p* control variables or `Index(-1)` if it is a given input.")
