...
void exportSmartEquilibriumSolver(py::module& m)
{
    py::class_<SmartEquilibriumSolver>(m, "SmartEquilibriumSolver")
        ...
        .def("solve", py::overload_cast<ChemicalState&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state.", py::arg("state"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumRestrictions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given reactivity restrictions.", py::arg("state"), py::arg("restrictions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumConditions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given constraint conditions.", py::arg("state"), py::arg("conditions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumConditions const&, EquilibriumRestrictions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given constraint conditions and reactivity restrictions.", py::arg("state"), py::arg("conditions"), py::arg("restrictions"), py::arg("c0"))

        .def("solve", py::overload_cast<ChemicalState&, EquilibriumSensitivity&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumSensitivity&, EquilibriumRestrictions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given reactivity restrictions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("restrictions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumSensitivity&, EquilibriumConditions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given constraint conditions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("conditions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, EquilibriumSensitivity&, EquilibriumConditions const&, EquilibriumRestrictions const&, ArrayXdConstRef const&>(&SmartEquilibriumSolver::solve), "Equilibrate a chemical state respecting given constraint conditions and reactivity restrictions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("conditions"), py::arg("restrictions"), py::arg("c0"))
