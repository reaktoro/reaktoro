...
void exportEquilibriumDims(py::module& m)
{
    py::class_<EquilibriumDims>(m, "EquilibriumDims")
        ...
        .def_readwrite("Ns", &EquilibriumDims::Ns, "The number of surfaces in the chemical system.")
        ...
        .def_readwrite("Nb", &EquilibriumDims::Nb, "The number of components (electric charge, chemical elements, extent of restricted reactions) in the chemical equilibrium problem (equivalent to `1 + Ne + Nr`).")
