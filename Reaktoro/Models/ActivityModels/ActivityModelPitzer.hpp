...
struct ActivityModelParamsPitzer
{
    ...
    enum CorrectionModel
    {
        ...
        LiDuan2007,         ///< Correction model based on formula \eq{} from Lia and Duan (2007) (see Table 12 in 10.1016/j.chemgeo.2007.07.023).
    };
    ...
    /// The attributes of an \eq{\alpha} parameter for a cation-anion or anion-cation pair.
    struct AlphaParamAttribs
    {
        /// The chemical formula of the first species in the species pair.
        ChemicalFormula formula1;

        /// The chemical formula of the second species in the species pair.
        ChemicalFormula formula2;

        /// The value of the \eq{\alpha} parameter for the above cation-anion or anion-cation pair.
        Param value;
    };
    ...
    Vec<AlphaParamAttribs> alpha1;       ///< The parameters \eq{\alpha_1_{ij}} associated to the parameters \eq{\beta^{(1)}_{ij}}.
    Vec<AlphaParamAttribs> alpha2;       ///< The parameters \eq{\alpha_2_{ij}} associated to the parameters \eq{\beta^{(1)}_{ij}}.
};
