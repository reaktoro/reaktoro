...
struct NasaThermoParams
{
    ...
    double q1 = {};   ///< The exponent \eq{q_1} in the regression model for \eq{C_{p}^{\circ}}.
    double q2 = {};   ///< The exponent \eq{q_2} in the regression model for \eq{C_{p}^{\circ}}.
    double q3 = {};   ///< The exponent \eq{q_3} in the regression model for \eq{C_{p}^{\circ}}.
    double q4 = {};   ///< The exponent \eq{q_4} in the regression model for \eq{C_{p}^{\circ}}.
    double q5 = {};   ///< The exponent \eq{q_5} in the regression model for \eq{C_{p}^{\circ}}.
    double q6 = {};   ///< The exponent \eq{q_6} in the regression model for \eq{C_{p}^{\circ}}.
    double q7 = {};   ///< The exponent \eq{q_7} in the regression model for \eq{C_{p}^{\circ}}.
