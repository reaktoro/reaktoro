...
// Reaktoro includes
#include <Reaktoro/Extensions/Supcrt/SupcrtDatabase2.hpp>
using namespace Reaktoro;

TEST_CASE("Testing SupcrtDatabase2 module", "[SupcrtDatabase2]")
{
    SupcrtDatabase2 db("supcrt98");
    ...
    // TODO: More tests are needed for SupcrtDatabase2, at different T and P values,
    {
