...
//     auto addAqueousPhaseHelper(const std::vector<Species>& species) -> AqueousPhase&
//     {
...
//         std::vector<Species> aqueous_species(species.size());
...
//     auto addGaseousPhaseHelper(const std::vector<Species>& species) -> GaseousPhase&
//     {
//         GeneralMixture mixture(species);
...
//             "Expecting at least one species name.");
//         std::vector<Species> gaseous_species(species.size());
//         for(unsigned i = 0; i < species.size(); ++i)
...
//     auto addMineralPhaseHelper(const std::vector<Species>& species) -> MineralPhase&
//     {
//         GeneralMixture mixture(species);
...
//             "Expecting at least one species name.");
//         std::vector<Species> mineral_species(species.size());
//         for(unsigned i = 0; i < species.size(); ++i)
