...
void exportIonExchangeProps(py::module& m)
{
    py::class_<IonExchangeProps>(m, "IonExchangeProps")
        ...
        .def("speciesEquivalences", &IonExchangeProps::speciesEquivalences)
        .def("speciesEquivalence", &IonExchangeProps::speciesEquivalence)
        ...
        .def("speciesLog10Gammas", &IonExchangeProps::speciesLog10Gammas)
        .def("speciesLog10Gamma", &IonExchangeProps::speciesLog10Gamma)
        .def("phase", &IonExchangeProps::phase, py::return_value_policy::reference_internal)
