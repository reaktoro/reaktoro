...
void exportSurfaceProps(py::module& m)
{
    py::class_<SurfaceProps>(m, "SurfaceProps")
        ...
        .def("charge", py::overload_cast<>(&SurfaceProps::charge, py::const_))
        .def("sigma", py::overload_cast<>(&SurfaceProps::sigma, py::const_))
        .def("potential", py::overload_cast<>(&SurfaceProps::potential, py::const_))
