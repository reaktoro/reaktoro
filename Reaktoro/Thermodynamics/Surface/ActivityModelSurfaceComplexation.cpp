...
auto activityModelSurfaceComplexationDDL(const SpeciesList& species) -> ActivityModel
{
...
{
    return ActivityModelSurfaceComplexationDDL();
}
...
auto ActivityModelSurfaceComplexationDDL() -> ActivityModelGenerator
{
    ...
    {
        return detail::activityModelSurfaceComplexationDDL(species);
    };
}
