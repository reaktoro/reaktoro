...
auto gaseousChemicalModelSpycherReed(const GaseousMixture& mixture) -> PhaseChemicalModel
{
    ...
    auto model = [=](const GaseousMixtureState state)
    {
        ...
        ChemicalScalar& V = res.molar_volume;
        ChemicalScalar& GR = res.residual_molar_gibbs_energy;
        ChemicalScalar& HR = res.residual_molar_enthalpy;
        ChemicalScalar& CPR = res.residual_molar_heat_capacity_cp;
        ChemicalScalar& CVR = res.residual_molar_heat_capacity_cv;
        ChemicalVector& ln_g = res.ln_activity_coefficients;
        ChemicalVector& ln_a = res.ln_activities;
