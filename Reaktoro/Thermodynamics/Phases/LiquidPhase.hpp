...
namespace Reaktoro {
	...
	/// Class that defines a liquid phase
	...
	public:
		...
		/// Construct an LiquidPhase instance with given liquid mixture.
		...
		auto setChemicalModelVanDerWaals()->LiquidPhase&;
		...
		auto setChemicalModelRedlichKwong()->LiquidPhase&;
		...
		auto setChemicalModelSoaveRedlichKwong()->LiquidPhase&;
		...
		auto setChemicalModelPengRobinson()->LiquidPhase&;

		/// Return the GaseousMixture instance
		auto mixture() const -> const LiquidMixture&;
