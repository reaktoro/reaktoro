...
public:
    ...
    /// Set Extended UNIQUAC (E-UNIQUAC) as Chemical Model of the phase.
    auto setChemicalModelEUNIQUAC() -> AqueousPhase&;
    auto setChemicalModelEUNIQUAC(const EUNIQUACParams& params) -> AqueousPhase&;
