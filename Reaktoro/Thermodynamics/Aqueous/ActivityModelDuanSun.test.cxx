...
TEST_CASE("Testing ActivityModelDuanSun", "[ActivityModelDuanSun]")
{
    ...
    WHEN("Using ActivityModelDuanSun() constructor")
    {
        ActivityModelDuanSun duansun;
        ActivityPropsFn fn = duansun.build(species);
    ...
    WHEN("Using ActivityModelDuanSun(CO2) constructor")
    {
        ActivityModelDuanSun duansun("CO2");
        ActivityPropsFn fn = duansun.build(species);
        fn(props, {T, P, x, extra});
    ...
    WHEN("Using ActivityModelDuanSun(NaCl) constructor")
    {
        ActivityModelDuanSun duansun("NaCl");
        ActivityPropsFn fn = duansun.build(species);
        fn(props, {T, P, x, extra});
