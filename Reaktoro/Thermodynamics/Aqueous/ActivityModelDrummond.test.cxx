...
TEST_CASE("Testing ActivityModelDrummond", "[ActivityModelDrummond]")
{
    ...
    WHEN("Using ActivityModelDrummond() constructor")
    {
        ActivityModelDrummond drummond;
        ActivityPropsFn fn = drummond.build(species);
    ...
    WHEN("Using ActivityModelDrummond(CO2) constructor")
    {
        ActivityModelDrummond drummond("CO2");
        ActivityPropsFn fn = drummond.build(species);
        fn(props, {T, P, x, extra});
    ...
    WHEN("Using ActivityModelDrummond(NaCl) constructor")
    {
        ActivityModelDrummond drummond("NaCl");
        ActivityPropsFn fn = drummond.build(species);
        fn(props, {T, P, x, extra});
