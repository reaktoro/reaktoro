...
public:
    ...
    virtual auto temperature() const -> Temperature = 0;

    /// Return the pressure (in units of Pa)
    virtual auto pressure() const -> Pressure = 0;
    ...
    virtual auto properties(Temperature T, Pressure P) -> ThermoModelResult = 0;

    /// Return the chemical properties of the species
    virtual auto properties(Temperature T, Pressure P, const Vector& n) -> ChemicalModelResult = 0;
