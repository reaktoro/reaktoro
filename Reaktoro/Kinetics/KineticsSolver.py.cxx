...
void exportKineticsSolver(py::module& m)
{
    py::class_<KineticsSolver>(m, "KineticsSolver")
        ...
        .def("solve", py::overload_cast<ChemicalState&, real const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval.", py::arg("state"), py::arg("dt"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, real const&, EquilibriumRestrictions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given reactivity restrictions.", py::arg("state"), py::arg("dt"), py::arg("restrictions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, real const&, EquilibriumConditions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given constraint conditions.", py::arg("state"), py::arg("dt"), py::arg("conditions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, real const&, EquilibriumConditions const&, EquilibriumRestrictions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given constraint conditions and reactivity restrictions.", py::arg("state"), py::arg("dt"), py::arg("conditions"), py::arg("restrictions"), py::arg("c0"))

        .def("solve", py::overload_cast<ChemicalState&, KineticsSensitivity&, real const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("dt"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, KineticsSensitivity&, real const&, EquilibriumRestrictions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given reactivity restrictions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("dt"), py::arg("restrictions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, KineticsSensitivity&, real const&, EquilibriumConditions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given constraint conditions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("dt"), py::arg("conditions"), py::arg("c0"))
        .def("solve", py::overload_cast<ChemicalState&, KineticsSensitivity&, real const&, EquilibriumConditions const&, EquilibriumRestrictions const&, ArrayXdConstRef>(&KineticsSolver::solve), "React a chemical state for a given time interval respecting given constraint conditions and reactivity restrictions and compute sensitivity derivatives.", py::arg("state"), py::arg("sensitivity"), py::arg("dt"), py::arg("conditions"), py::arg("restrictions"), py::arg("c0"))
