...
using DaeFunction = std::function<int(double t, VectorXdConstRef u, VectorXdConstRef udot, VectorXdRef F)>;

/// The function signature of the Jacobian of the right-hand side function of a system of ordinary differential equations.
using DaeJacobian = std::function<int(double t, VectorXdConstRef u, VectorXdConstRef udot, MatrixXdRef J)>;
...
public:
    ...
    auto function(double t, VectorXdConstRef y, VectorXdConstRef ydot, VectorXdRef f) const -> int;
    ...
    /// @return Return 0 if successful, any other number otherwise.
    auto jacobian(double t, VectorXdConstRef y, VectorXdConstRef ydot, MatrixXdRef J) const -> int;
